...
//                 ) : (
//                   <img src="/images/user.svg" alt="Default User Profile" />
//                 )}
//                 <span>{props.user.displayName}</span>
//               </UserInfo>
//               <Editor>
...
// const mapStateToProps = (state) => {
//     return {
//       user: state.useState && state.useState.user ? state.useState.user : {},
//     };
//   };
...
const PostModal = (props) => {
  ...
  const postArticle = async (e) => {
    ...
    let downloadURL = "";
    if (shareImage) {
      const storageRef = ref(getStorage(), `images/${shareImage.name}`);
      await uploadBytes(storageRef, shareImage);
...
const mapStateToProps = (state) => {
  return {
    user: state.useState && state.useState.user
      ? state.useState.user
      : {},
  };
};
